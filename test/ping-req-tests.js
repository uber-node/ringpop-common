...
function validate(n, fns, deadline) {
    var tc = createCoordinator(n);
    tc.start();

    dsl.validate(t, tc, fns, deadline)
}

// function skelleton(t, tc, n, spot1) {
//     return [
...
//         dsl.sendPing(t, tc, 0, {sourceIx: 0, subjectIx: ix, status: status }),
//         dsl.waitForPingResponse(t, tc),
